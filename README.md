...
*radtags*, to proceed to *ustacks* and the rest of the STACKS pipeline. The results of the image are the following, located in the same directory the raw data live in:

1. One file for each raw read, generated by fastqc.
